...
public class RegistroParqueo {
	...
	public RegistroParqueo(Long id, Calendar fechaIngreso, Calendar fechaSalida,
			TipoVehiculoEnum tipoVehiculo, char esMotoPesada, String placa, double valorFacturado) {
		this.id = id;
